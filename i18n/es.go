...
var ES = map[string]string{
	...
	"describe_site":    "Describe lo que necesitas",
	...
	"editor_tag_limit":               "Puedes escoger únicamente hasta 3 palabras clave y cada una no puede exceder los 24 caracteres",
	"editor_publish_to_show_in_home": "Publica este sitio para poder mostrarlo en la página principal",
